...
const page = () => {
  return (
    <ThrownLayout header={2}>
      ...
      {/*==================================================*/}
      <div className="about-area style-four dark">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12">
              <div className="about-thumb four">
                ...
                <div className="about-counter four dark">
                  <div className="about-countent-content four dark">
                    <div className="about-counter-numbar">
                      <h5 className="counter">
                        <Counter end={17} />
                      </h5>
                    </div>
                    <div className="about-counter-discription dark">
      ...
      {/*==================================================*/}
      <div className="project-area style-four dark">
        <div className="container">
          <div className="row">
      ...
      {/*==================================================*/}
      <div className="blog-area style-four dark">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="blog-items-four dark">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-items-four dark inner">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="blog-four-discription dark">
                <p>
