...
const page = () => {
  return (
    <ThrownLayout header={4} dark>
      ...
      {/*==================================================*/}
      <div className="conversion-area dark">
        <div className="container">
      ...
      {/*==================================================*/}
      <div className="about-area style-five dark">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <div className="about-thumb">
                <img src="assets/images/about/about-5.png" alt="image" />
                <div className="about-counter-five dark">
      ...
      {/*==================================================*/}
      <div className="team-area style-five dark">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
      ...
      {/*==================================================*/}
      <div className="testimonial-area style-five dark">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
            ...
            <div className="col-lg-6 col-md-12">
              <div className="testi-title">
                ...
                <div className="testi-main-title dark">
