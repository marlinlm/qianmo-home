...
const page = () => {
  return (
    <ThrownLayout header={3} dark>
      ...
      {/*==================================================*/}
      <div className="about-area style-three dark">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12">
              <div className="section-title">
                ...
                <div className="section-main-title about3 dark">
                  <h2>Best It &amp; Technology Agency</h2>
                  <h2>For Your Business</h2>
                </div>
              </div>
              <div className="about-content">
                <div className="about-discribtion style-three dark">
                  <p>
                ...
                <div className="process-ber-plugin">
                  <span className="process-bar dark">
                    Best It &amp; Technology
                  </span>
                  ...
                  <span className="process-bar dark">Health ValuableIdeas</span>
                ...
                <div className="about-bottom">
                  ...
                  <div className="about-bottom-title dark">
                    <h4>Max Benjamin</h4>
                    <span>Director</span>
                  </div>
                  <div className="about-signiture">
                    <img src="assets/images/about/signiture.png" alt />
                  </div>
                </div>
              </div>
            </div>
      ...
      {/*==================================================*/}
      <div className="service-area style-three dark">
        <div className="container">
          <div className="row">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="service-single-box style-three dark">
                <div className="service-conten style-three">
                  <div className="service-title style-three dark">
                    <h4>
                  ...
                  <div className="serivice-discription style-three dark">
                    <p>
      ...
      {/*==================================================*/}
      <div className="team-area style-three dark">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <div className="section-sub-title dark">
                  <h4>OUR WORKERS</h4>
                </div>
                <div className="section-main-title dark">
          ...
          <div className="row">
            <div className="col-md-6 col-xl-3">
              <div className="team-items-box dark">
                <div className="team-itmes-content dark">
                  <h4>
      ...
      {/*==================================================*/}
      <div className="testimonial-area dark">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
          ...
          <div className="row">
            <div className="testi_list">
              <Swiper {...sliderProps.testimonial}>
                <SwiperSlide>
                  <div className="testi-single-box dark">
                    <div className="testi-thumb">
                      <img src="assets/images/testimonial/testi1.png" alt="" />
                    </div>
                    <div className="testi-content">
                      <div className="testi-title dark">
                        <h4>Charlize Theron</h4>
                        <span>Trainer</span>
                      </div>
                      <div className="testi-discription dark">
                        <p>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              ...
              <div className="blog-single-box dark">
                <div className="blog-content">
                  <div className="blog-title dark">
                    <h4>
                  ...
                  <div className="blog-discription dark">
                    <p>
                  ...
                  <div className="blog-bottom-title dark">
                    <h4>Admin</h4>
                  </div>
                  <div className="blog-btn dark">
                    <a href="#">
