...
const page = () => {
  return (
    <ThrownLayout dark>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12">
              <div className="section-title">
                ...
                <div className="about-main-title dark">
                  <h2>Connecting your Business</h2>
                  <h2>With The World</h2>
                </div>
              </div>
              <div className="about-content">
                <div className="about-discribtion dark">
                  <p>
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6">
                    ...
                    <div className="about-single-box dark">
      ...
      {/*==================================================*/}
      <div className="service-area dark">
        <div className="container">
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-6 col-xl-3">
              <div className="service-single-box dark">
                ...
                <div className="service-content">
                  ...
                  <div className="serivice-discription dark">
                    <p>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
                ...
                <div className="section-main-title team dark">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="team-single-box">
                ...
                <div className="team-content dark">
                  <div className="team-title dark">
                    <h4>
      ...
      {/*==================================================*/}
      <div className="sales-report-area dark">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-md-6">
              <div className="section-title">
                <div className="section-main-title sales dark">
                  <h2>How we Plan to </h2>
                  <h2>Disrupt the Strategy</h2>
                </div>
              </div>
              <div className="sales-content">
                <div className="sales-discription dark">
                  <p>
